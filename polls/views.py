...
class NewSurvey(forms.Form):
    ...
    describe = forms.CharField(required = False, label=mark_safe("If yes, please describe the situation:"), max_length = 1000, widget=forms.Textarea(attrs= {'cols' : 100, 'rows' : 10}))
    ...
    which_features_used = forms.CharField(required = False, label=mark_safe("29. Which accessibility features did you use?"), max_length = 1000, widget=forms.Textarea(attrs= {'cols' : 100, 'rows' : 10}))
    which_features_helpful = forms.CharField(required = False, label=mark_safe("30. Which accessibility features did you find most helpful?"), max_length = 1000, widget=forms.Textarea(attrs= {'cols' : 100, 'rows' : 10}))
    improvements = forms.CharField(required = False, label=mark_safe("31. What improvements would you suggest for this voting system?"), max_length = 1000, widget=forms.Textarea(attrs= {'cols' : 100, 'rows' : 10}))
